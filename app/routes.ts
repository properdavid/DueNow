...
export default [
  ...
  route("api/comments/:id/delete", "routes/api.comments.$id.delete.tsx"),
  route("api/comments/:id/edit", "routes/api.comments.$id.edit.tsx"),
  route("api/parents", "routes/api.parents.tsx"),
  route("api/settings/theme", "routes/api.settings.theme.tsx"),
  route("api/settings/timezone", "routes/api.settings.timezone.tsx"),
  route("api/labels/create", "routes/api.labels.create.tsx"),
  route("api/labels/:id/rename", "routes/api.labels.$id.rename.tsx"),
  route("api/labels/:id/delete", "routes/api.labels.$id.delete.tsx"),
  route("api/work-items/:id/add-comment", "routes/api.work-items.$id.add-comment.tsx"),
