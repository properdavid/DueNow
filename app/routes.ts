...
export default [
  ...
  route("api/work-items/:id/attach-label", "routes/api.work-items.$id.attach-label.tsx"),
  route("api/work-items/:id/create-label", "routes/api.work-items.$id.create-label.tsx"),
  route("api/work-items/:id/detach-label", "routes/api.work-items.$id.detach-label.tsx"),
