...
import { attachLabelToWorkItem } from "~/domain/work-items/work-items.server";
...
export async function action({ request, params, context }: ActionFunctionArgs) {
  ...
  return runFieldUpdate(() => attachLabelToWorkItem(getDatabase(context), id, labelId, user.id));
}
